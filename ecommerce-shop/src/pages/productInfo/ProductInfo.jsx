        ...
        />
              ...
              <div className="lg:w-1/2 w-full flex flex-col lg:pl-10">
                <div className="lg:w-full lg:py-6 mt-6 lg:mt-0">
                  ...
                  <h1 className="text-3xl title-font font-medium mb-1" style={{ color: "#011F9E" }}>
                    {products.title}
                  </h1>
                    ...
                    <span className="flex items-center">
                      ...
                      {[...Array(5)].map((_, i) => (
                        <svg
                          ...
                          strokeWidth={2}
                          className={`w-4 h-4 ${i < 4 ? 'text-red-500' : 'text-gray-200'}`}
                          viewBox="0 0 24 24"
                        >
                  ...
                  <div className="flex items-center">
                    <span className="title-font font-medium text-2xl mr-4" style={{ color: "#011F9E" }}>
                      ₹{products.price}
                    </span>
                    <button
